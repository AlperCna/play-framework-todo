...
/**
 * `users` tablosu + duz [[UserRow]] (ikisi birlikte degisir, ayni dosyada).
 *
 * Yeni bir entity eklemek = boyle bir fragment dosyasi yazmak + [[Tables]] cephesine
 * `with UsersTable` eklemek. Mevcut dosyalara dokunulmaz.
 */
